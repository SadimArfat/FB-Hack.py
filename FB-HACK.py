...
print '%s||[#]%s--------------%s[ Sadim Maker ]%s---------------%s[#]||%s' % (Y, R, Y, R, Y, N)

print '%s||%s |___________%s[ Prince Sadim Maker ]%s____________|%s ||%s' % (Y, R, Y, R, Y, N)

print '%s||%s |____________%s[ Arfat  * Session ]%s_____________|%s ||%s' % (Y, R, Y, R, Y, N)
